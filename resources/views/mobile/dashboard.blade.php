...
<div class="mx-4 mt-4 pb-28">
    ...
    <div class="relative overflow-hidden bg-gradient-to-br from-indigo-700 to-purple-700 rounded-2xl shadow-xl p-6 mb-5 backdrop-blur-lg animate-gradient-bg">
        ...
        <div class="relative flex flex-col sm:flex-row items-start sm:items-center justify-between">
            <div>
                <h2 class="text-2xl font-extrabold text-white mb-2 animate-slide-in">Welcome, {{ $user->name }}! 🚀</h2>
    ...
    <div class="grid grid-cols-2 gap-4 mb-5">
        <a href="{{ route('spin') }}" class="group relative bg-gradient-to-br from-purple-600 to-pink-600 text-white rounded-2xl p-5 shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1">
        ...
        <a href="{{ route('ads.show') }}" class="group relative bg-gradient-to-br from-indigo-600 to-cyan-500 text-white rounded-2xl p-5 shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1">
            <div class="absolute inset-0 bg-white opacity-0 group-hover:opacity-20 transition-opacity rounded-2xl"></div>
            <div class="flex items-center">
    ...
    <div class="mb-5">
        ...
        <div class="grid grid-cols-2 gap-4">
            <a href="{{ route('coming-soon') }}" class="group relative bg-gradient-to-br from-yellow-500 to-orange-500 text-white rounded-2xl p-5 shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1">
                <div class="absolute inset-0 bg-white opacity-0 group-hover:opacity-20 transition-opacity rounded-2xl"></div>
                <div class="flex items-center">
            ...
            <a href="{{ route('coming-soon') }}" class="group relative bg-gradient-to-br from-green-500 to-teal-500 text-white rounded-2xl p-5 shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1">
                <div class="absolute inset-0 bg-white opacity-0 group-hover:opacity-20 transition-opacity rounded-2xl"></div>
                <div class="flex items-center">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-md p-5 mb-5">
        ...
        <div class="flex flex-col gap-3">
            ...
            <a href="{{ route('withdraw.history') }}" class="block w-full bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white rounded-lg py-3 text-center text-sm font-semibold transition transform hover:scale-105" @click="navigator.vibrate(50)">Withdraw History</a>
        </div>
        </div> 
    ...
    <div class="mb-5">
        ...
        <div class="space-y-4" style="margin-bottom: -50px;">
...
<div class="fixed bottom-24 right-4 z-40">
    <a href="{{ route('support.create') }}" class="group flex items-center justify-center bg-gradient-to-r from-purple-600 to-pink-600 text-white w-12 h-12 rounded-full shadow-xl hover:shadow-2xl transition transform hover:scale-110" @click="navigator.vibrate(50)">
